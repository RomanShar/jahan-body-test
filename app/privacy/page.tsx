    ...
    <main className="min-h-screen bg-brand-body py-20 px-6">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="prose max-w-none space-y-6 text-brand-muted leading-relaxed">
          ...
          <h2 className="text-xl font-bold text-brand-dark mt-8">Как мы используем данные</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-brand-dark mt-8">Хранение данных</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-brand-dark mt-8">Ваши права</h2>
          <p>
            Вы можете запросить удаление ваших данных в любой момент, написав нам на email.
          </p>

          <h2 className="text-xl font-bold text-brand-dark mt-8">Контакт</h2>
          <p>
