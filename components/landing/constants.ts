...
export const hero = {
  ...
  urgencyBadges: ['✓ 15+ лет практики', '✓ 1500+ участников', '✓ 8 из 20 мест занято'],
  heroImages: [
    '/images/landing/gallery/moment-07-beach-embrace.webp',
    '/images/landing/gallery/moment-10-water-joy.webp',
  ],
}
...
export const manifesto: ManifestoData = {
  quote: '«Пока тело не расслаблено - до переживаний не добраться. Дыхание - это первый ключ.\nЛюди приходят и говорят: "Я всё понял в терапии, но мне всё равно плохо".\nПотому что понимание не меняет химию тела. Движение - меняет.\n\nМы всю жизнь двигались - бегали, танцевали. Это наша база.\nЧерез свободное движение тело само находит, где зажатость, и само её отпускает.»',
...
export const resultsSection = {
  ...
  items: [
    {
      number: '01',
      text: 'Через неделю: дышите глубже, засыпаете спокойнее, тело перестаёт быть фоном',
      iconName: 'zap' as const,
    },
    {
      number: '02',
      text: 'Через месяц: партнёр спрашивает «что с тобой случилось?» - без объяснений',
      iconName: 'heart' as const,
    },
    {
      number: '03',
      text: 'Тревога и фоновое напряжение снижаются - тело перестаёт быть в режиме защиты',
      iconName: 'shield' as const,
    },
    {
      number: '04',
      text: 'Появляется способность быть в контакте - без необходимости защищаться или контролировать',
      iconName: 'users' as const,
    },
    {
      number: '05',
      text: 'Научитесь чувствовать и защищать свои границы и желания - телом, а не словами',
      iconName: 'compass' as const,
    },
    {
      number: '06',
      text: 'Заберёте практики на каждый день - 5 минут утром меняют всё',
      iconName: 'home' as const,
    },
    {
      number: '07',
      text: 'Перестанете жить на автопилоте - начнёте выбирать, чувствовать и кайфовать',
      iconName: 'compass' as const,
    },
  ],
}
...
export const targetAudience = {
  ...
  items: [
    'Хотите чувствовать себя в теле мощно и свободно',
    'Чувствуете, что внутри больше энергии, чем выходит наружу',
    'Хотите близости - настоящей, телесной, без игр и масок',
    'Ходите к психологу, но тело всё ещё зажато - понимание есть, а ощущений нет',
    'Переехали в другую страну и чувствуете, что потеряли контакт с собой',
    'Чувствуете, что вам сложно сказать «нет» и обозначить своё',
    'Хотите, чтобы люди чувствовали вашу энергию ещё до первого слова',
  ],
}
...
// ===== MOBILE CTA =====
export const mobileCTAText = 'Занять место · 8 из 20'
