...
export const hero = {
  ...
  socialProof: [
    ...
    'Закрытая группа до 20 участников',
...
export const resultsSection = {
  ...
  items: [
    ...
    },
    {
      ...
      results: ['Тело становится чувствительным, тёплым, отзывчивым', 'Вы начинаете дышать полной грудью', 'Уходит привычная скованность в плечах, челюсти, животе', 'Появляется ощущение «мне радостно», а не «я держусь»'],
      closing: 'Когда тело больше не защищается — появляется энергия жить, чувствовать и выбирать.',
    ...
    },
    {
      ...
      results: ['Появляется флирт и лёгкость', 'Появляется внутренняя лёгкость без потери устойчивости', 'Близость перестаёт быть задачей', 'Вы действуете из ощущений и интереса, а не из чувства вины или обязанности'],
      closing: 'Это состояние, в котором вы не теряете контроль. Вы просто перестаёте тратить силы на борьбу с жизнью.',
      image: '/images/landing/results/step-03-spontaneity.webp',
    },
    {
      number: '04',
      title: 'Контакт, который ощущается',
      text: 'Когда вы возвращаетесь в тело — контакт появляется сам.',
      results: ['Вы замечаете другого через дыхание и прикосновение, а не через мысли', 'Прикосновения снова становятся живыми', 'Появляется возбуждение', 'Партнёр начинает чувствовать перемены без объяснений'],
      closing: 'Это возвращение к естественным реакциям, которые невозможно сыграть или придумать.',
      image: '/images/landing/results/step-04-felt-contact.webp',
    },
    {
      number: '05',
      title: 'Опыт, который остаётся после ретрита',
      text: 'Это не эмоциональный всплеск на выходные.',
      results: ['Простые телесные практики, которые легко встроить в повседневность', 'Ясное ощущение своих телесных «да» и «нет» — когда тело соглашается, а когда тихо закрывается', 'Способность оставаться устойчивым даже в период перегрузки, изменений и эмиграционного стресса', 'Возвращение живости, интереса и радости в обычные дни'],
      closing: 'Это опыт, который остаётся внутри — как новое качество присутствия в собственной жизни.',
...
export const facilitator = {
  ...
  bio: 'Я работаю с телом больше 15 лет. Движение, дыхание, звук, прикосновение — через них люди возвращают себе то, что потеряли: мощь, кайф, способность чувствовать.',
  credentials: [
    'Преподаватель шиацу',
  ],
...
export const pricing = {
  ...
  applicationNote: 'После заявки — короткое собеседование (15–20 мин), чтобы познакомиться и убедиться, что программа ретрита подходит именно вам.',
}
...
export const faqItems: FAQItem[] = [
  ...
  },
  {
    ...
    answer: 'Очень круто, если вы придёте парой. Ретрит станет огромным вкладом в ваши отношения. Программа рассчитана как на индивидуальное участие, так и на парное. И в том и в другом случае вы получите удовольствие и узнаете много нового о своём теле.',
  },
  {
    question: 'Какие рекомендации, если мы идем парой?',
    answer: 'Вам нужно заранее договориться — будете ли вы выполнять упражнения только друг с другом или вам ок практиковать с другими участниками. Ответ на этот вопрос почувствуйте интуитивно и честно обсудите со своим партнером. Ни одно из упражнений ретрита не нарушает общепринятых этических норм.',
  },
  {
    question: 'Какие рекомендации, если я иду один?',
    answer: 'Лучшее, что вы можете сделать для себя — приехать в ресурсном состоянии. Качественно высыпайтесь в течение всей недели до ретрита. Исключите алкоголь. И предупредите всех, что вы отключите телефон на 3 дня.',
  },
  {
    question: 'Сколько участников будет на ретрите?',
    answer: 'Это будет камерный ретрит на 20 человек.',
  },
  {
  ...
  {
    question: 'Расскажите про этические аспекты ретрита',
    answer: 'Язык ретрита — это взрослые смыслы для современных людей. Ни одно из упражнений не нарушает личные границы. Все участники одеты.',
  },
  {
    question: 'На каком языке проходит ретрит?',
    answer: 'На русском. Это один из немногих русскоязычных соматических ретритов в Европе.',
  },
  {
    question: 'Какова политика возврата?',
    answer: 'Полный возврат при отмене за 28+ дней. 50% при отмене за 14–28 дней. Менее 14 дней — перенос на следующий ретрит.',
  },
]
...
export const finalCTA = {
  ...
  healthDisclaimer: 'Ретрит не является медицинской диагностикой. Для медицинских вопросов обратитесь к врачу.',
}
