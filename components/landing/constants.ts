...
export const manifesto: ManifestoData = {
  quote: '«Пока тело не расслаблено —\nдо головы не достучаться.»',
...
export const resultsSection = {
  ...
  items: [
    ...
    { number: '05', text: 'Границы перестанут быть теорией — вы ощутите право сказать «нет» или «да» телом, без вины и оправданий' },
...
export const faqItems: FAQItem[] = [
  ...
  {
    question: 'Мне за 30 (40, 50) — не поздно?',
    answer: 'Большинство участников — именно в этом возрасте. После 30 приходят честные вопросы: «Насколько я счастлив? Что дальше?». Тело не стареет для этой работы — оно ждало этого внимания годами.',
  },
  {
