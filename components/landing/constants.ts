...
export const faqItems: FAQItem[] = [
  ...
  },
  {
    ...
    answer: 'Это нормально. Так думает почти каждый, кто потом говорит: «Это лучшее, что я сделал за последние годы». Тело просто боится перемен, поэтому включает сомнения. Если чувствуете хотя бы лёгкий отклик — доверьтесь ему.',
  },
  {
  ...
  },
  {
    ...
    answer: 'Тренинг создан как раз для таких людей. Он не требует расслабления - он создаёт условия, в которых тело само начинает оттаивать. Первый день целиком посвящён созданию безопасности.',
  },
  {
