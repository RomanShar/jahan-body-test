...
export const philosophyPillars: PhilosophyPillar[] = [
  {
    ...
    description: 'На тренинге нет хореографии и правил. Вы просто двигаетесь - как хочет тело. Через 20 минут плечи опускаются, челюсть расслабляется, и вы чувствуете себя иначе.',
    iconName: 'move',
  },
  {
    name: 'Дыхание',
